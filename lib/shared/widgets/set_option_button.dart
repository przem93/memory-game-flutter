...
/// Reusable set option button (icon + label) used on Customize and Select Set screens.
class SetOptionButton extends StatefulWidget {
  const SetOptionButton({
    required this.label,
  ...
  static const containerKey = ValueKey<String>('setOptionButtonContainer');
  static const semanticsKey = ValueKey<String>('setOptionButtonSemantics');
  static const iconSlotKey = ValueKey<String>('setOptionButtonIconSlot');
  static const labelKey = ValueKey<String>('setOptionButtonLabel');
  ...
  @override
  State<SetOptionButton> createState() => _SetOptionButtonState();
}

class _SetOptionButtonState extends State<SetOptionButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      key: SetOptionButton.semanticsKey,
      ...
      child: AnimatedScale(
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            key: SetOptionButton.containerKey,
            duration: const Duration(milliseconds: 90),
            width: _width,
            height: _height,
            ...
            child: Row(
              ...
              children: [
                SizedBox.square(
                  key: SetOptionButton.iconSlotKey,
