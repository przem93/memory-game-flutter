...
class _CustomizeScreenState extends State<CustomizeScreen> {
  ...
  String _selectedSetKey = CustomizeStartPayload.defaultSetKey;

  @override
  Widget build(BuildContext context) {
    final setEntry = resolveSetEntry(_selectedSetKey);
    ...
    return CustomizeSceneShell(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return Semantics(
            key: CustomizeScreen.contentKey,
            container: true,
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  key: CustomizeScreen.logoSlotKey,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          key: CustomizeScreen.closeButtonSlotKey,
                          child: SizedBox(
                            width: gridWidth,
  ...
  void _onSetSelectorTap(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (selectSetContext) => SelectSetScreen(
          initialSelectedSetKey: _selectedSetKey,
          onSetSelected: (setKey) {
            setState(() {
              _selectedSetKey = setKey;
            });
          },
        ),
      ),
  ...
  void _onCardCountSelected(BuildContext context, int cardCount) {
    final payload = resolveCustomizeStartPayload(cardCount, _selectedSetKey);
    if (widget.onStartRequested != null) {
      widget.onStartRequested!(payload);
      return;
    }
  }
}
